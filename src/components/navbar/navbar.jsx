...
import logo from '../../assets/bujadeals6.png'
    ...
    <div>
      <div className={'bg-[skyblue] border-b-black border-b-2 flex flex-col items-center justify-around w-full lg:hidden py-5'}>
        <div className='flex flex-row gap-5'>
          <a href={"/home"} onClick={() => location.reload}><span className='text-2xl font-bold'><img className='w-[250px] mb-[-20px]' src={logo} /></span></a>
