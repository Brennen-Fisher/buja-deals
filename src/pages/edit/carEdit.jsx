...
function CarEdit() {
    ...
    return (
        <div className='bg-[skyblue] w-full flex justify-center items-center flex-col p-5'>
            <form className='bg-white flex  w-full lg:w-[50%] flex-col items-center gap-[10px]' onSubmit={handleCarSubmission}>
                ...
                <div id='basic' className='w-full flex flex-col items-center gap-[50px]'>
                    ...
                    <div className='w-[75%] grid grid-cols-2 gap-[20px] pb-14'>
                        ...
                        <label className='flex flex-col items-start'>
                            ...
                            <input className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' name='year' type="text" maxlength="4" required value={year} onChange={(e) => setYear(e.target.value)} />
                        </label>
                        <label className='flex flex-col items-start'>
                        ...
                        <label className='flex flex-col items-start'>
                            ...
                            <input className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' name='mileage' type="text" required value={mileage} onChange={(e) => setMileage(e.target.value)} />
                        </label>
                        <label className='flex flex-col items-start'>
                            {lang === "En" ? "Change Miles per Gallon:" : "Changer des miles par gallon:"}
                            <input className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' name='mpg' type="text" required value={mpg} onChange={(e) => setMpg(e.target.value)} />
                        </label>
                        <label className='flex flex-col items-start'>
                ...
                <div id='size' className='w-full flex flex-col items-center gap-[50px]'>
                    ...
                    <div className='w-[75%] grid grid-cols-2 gap-[20px] pb-14'>
                        ...
                        <label className='flex flex-col items-start'>
                            ...
                            <input className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' name='yor' type="text" required value={yor} onChange={(e) => setYor(e.target.value)} />
                        </label>
                ...
                <div id='additional' className='w-full flex flex-col items-center gap-[50px]'>
                    ...
                    <div className='w-[75%] grid grid-cols-2 gap-[20px] pb-14'>
                        ...
                        <label className='flex flex-col items-start'>
                            ...
                            <textarea value={feat} onChange={(e) => setFeat(e.target.value)} name='feat' className="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='Airconditioned | Parking | 3 Stories'></textarea>
                        </label>
                        <label className='flex flex-col items-start'>
